...
local jwt_decoder = require "kong.plugins.jwtrefresh.jwt_parser"
...
local function do_authentication(conf)
  ...
  local jwt, err = jwt_decoder:new(token,conf)
  if err then
  ...
  local ok_claims, errors = jwt:verify_registered_claims(conf.claims_to_verify,conf)
